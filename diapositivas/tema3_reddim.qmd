...
-   Los datos son una matriz de distancias o de similitudes --\> no se tienen observaciones y variables, se tienen distancias (o similitudes) entre ellos (Ej: comparación de productos para marketing)
