...
plot(datos_con_outliers$x, datos_con_outliers$y,
     col = km$cluster, pch = 19, cex = 1.2,
     main = "K-medias (sensible a outliers)",
     xlab = "x", ylab = "y")
# Dibujar centroides: primero borde blanco grueso, luego símbolo de color
for(i in 1:nrow(km$centers)) {
  points(km$centers[i, 1], km$centers[i, 2],
         col = "white", pch = 4, cex = 3.5, lwd = 6)  # Borde blanco
  points(km$centers[i, 1], km$centers[i, 2],
         col = i, pch = 4, cex = 3, lwd = 4)  # X del color del cluster
}
# Resaltar outliers con círculos azules
points(outliers[, 1], outliers[, 2], col = "blue", pch = 1, cex = 2, lwd = 3)
legend("topright", c("Centroides", "Outliers"),
       col = c("black", "blue"), pch = c(4, 1), pt.lwd = c(4, 3), cex = 0.8)

# K-medoides
plot(datos_con_outliers$x, datos_con_outliers$y,
     col = pam_res$cluster, pch = 19, cex = 1.2,
     main = "K-medoides (robusto a outliers)",
     xlab = "x", ylab = "y")
# Dibujar medoides: primero borde blanco grueso, luego símbolo de color
# pam_res$id.med contiene los índices de las observaciones que son medoides
medoid_coords <- datos_con_outliers[pam_res$id.med, ]
for(i in 1:nrow(medoid_coords)) {
  points(medoid_coords$x[i], medoid_coords$y[i],
         col = "white", pch = 4, cex = 3.5, lwd = 6)  # Borde blanco
  points(medoid_coords$x[i], medoid_coords$y[i],
         col = i, pch = 4, cex = 3, lwd = 4)  # X del color del cluster
}
# Resaltar outliers con círculos azules
points(outliers[, 1], outliers[, 2], col = "blue", pch = 1, cex = 2, lwd = 3)
legend("topright", c("Medoides", "Outliers"),
       col = c("black", "blue"), pch = c(4, 1), pt.lwd = c(4, 3), cex = 0.8)
...
plot(som_model, type = "mapping",
     pch = 19,  # Usar puntos sólidos en lugar de etiquetas de texto
